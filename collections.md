...
31) [Начальная ёмкость коллекций](#Начальная-ёмкость-коллекций)
...
| Base Class | Base Interface | AD | AN | Inserted Order | Sorted order | Synchronized | Random access | Default capacity |
| :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: |
| AbstractList | List | Yes | Yes | Yes | No | No | Yes | 10 |
| Abstract SequentialList | List/Deque/Queue | Yes | Yes | Yes | No | No | Yes | 0 |
| AbstractSet | Set | No | Yes | No | No | No | No | 16 |
| HashSet | - | No | Yes | Yes | No | No | No | 16 |
| AbstractSet | Navigable Set | No | No  | No  | Yes | No | No | 16 |
| AbstractQueue | Queue | Yes | No  | No  | Yes | No | No | 11 |
| Abstract Collection| Deque | Yes | No  | Yes  | No | No | No | 16 |
| AbstractSet | Set | No | No | Yes | No | No |  |  |
+ [Вопрос#31  К оглавлению](#Framework-Collections)
...
| Худшее (java 8+) | O(Log2(n)) | O(Log2(n)) | O(Log2(n)) |

__HashMap__ – внутри состоит из корзин и списка элементов, на которые ссылаются корзины.
Корзины – массив
...
+ [Вопрос#32  К оглавлению](#Framework-Collections)
...
+ [Вопрос#33  К оглавлению](#Framework-Collections)
...
```
+ [Вопрос#34  К оглавлению](#Framework-Collections)
...
+ [Структуры данных в картинках. ArrayList(2011)-->]( https://habr.com/ru/post/128269/ )
+ [Структуры данных в картинках. LinkedList(2011)-->]( https://habr.com/ru/post/127864/ )
+ [Структуры данных в картинках. HashMap(2012)-->]( https://habr.com/ru/post/128017/ )
+ [Структуры данных в картинках. LinkedHashMap(2012)-->]( https://habr.com/ru/post/129037/ )
+ [Название-->]( Ссылка )
+ [Название-->]( Ссылка )
