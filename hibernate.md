...
+ [Для чего нужна аннотация @Cache?](#Для-чего-нужна-аннотация-Cache)
+ [Для чего нужна аннотация @Cacheable?](#Для-чего-нужна-аннотация-Cacheable)
...
+ [Для чего нужна аннотация ID? Какие @GeneratedValue вы знаете?](#Для-чего-нужна-аннотаци-ID-Какие-GeneratedValue-вы-знаете)
