...
+ [Что такое `__Wildcards__)`?](#Что-такое-Wildcards)
+ [Что такое `The Get and Put Principle` или __PECS__ (`Producer Extends Consumer Super`?](#The-Get-and-Put-Principle-или-PECS-Producer-Extends-Consumer-Super)
