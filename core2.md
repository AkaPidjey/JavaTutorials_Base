...
# Theme5___InputOutputSreams
1) [Какие существуют виды потоков ввода/вывода?](#Какие-существуют-виды-потоков-ввода-вывода)
2) [Назовите основные предки потоков ввода/вывода?](#Назовите-основные-предки-потоков-ввода-вывода)
3) [Что общего и чем отличаются следующие потоки: `InputStream`, `OutputStream`, `Reader`, `Writer`?](#Что-общего-и-чем-отличаются-следующие-потоки-InputStream-OutputStream-Reader-Writer)
4) [В каких пакетах лежат классы-потоки?](#В-каких-пакетах-лежат-классы-потоки)
5) [В чём заключается разница между IO и NIO?](#В-чём-заключается-разница-между-io-и-nio)
6) [Какие особенности NIO вы знаете?](#Какие-особенности-nio-вы-знаете)
7) [Что такое _«каналы»_?](#Что-такое-каналы)
8) [Какие подклассы класса `InputStream` вы знаете, для чего они предназначены?](#Какие-подклассы-класса-inputstream-вы-знаете-для-чего-они-предназначены)
9) [Для чего используется `PushbackInputStream`?](#Для-чего-используется-pushbackinputstream)
10) [Для чего используется `SequenceInputStream`?](#Для-чего-используется-sequenceinputstream)
11) [Какой класс позволяет читать данные из входного байтового потока в формате примитивных типов данных?](#Какой-класс-позволяет-читать-данные-из-входного-байтового-потока-в-формате-примитивных-типов-данных)
12) [Какие подклассы класса `OutputStream` вы знаете, для чего они предназначены?](#Какие-подклассы-класса-outputstream-вы-знаете-для-чего-они-предназначены)
13) [Какие подклассы класса `Reader` вы знаете, для чего они предназначены?](#Какие-подклассы-класса-reader-вы-знаете-для-чего-они-предназначены)
14) [Какие подклассы класса `Writer` вы знаете, для чего они предназначены?](#Какие-подклассы-класса-writer-вы-знаете-для-чего-они-предназначены)
15) [В чем отличие класса `PrintWriter` от `PrintStream`?](#В-чем-отличие-класса-printwriter-от-printstream)
16) [Чем отличаются и что общего у `InputStream`, `OutputStream`, `Reader`, `Writer`?](#Чем-отличаются-и-что-общего-у-inputstream-outputstream-reader-writer)
17) [Какие классы позволяют преобразовать байтовые потоки в символьные и обратно?](#Какие-классы-позволяют-преобразовать-байтовые-потоки-в-символьные-и-обратно)
18) [Какие классы позволяют ускорить чтение/запись за счет использования буфера?](#Какие-классы-позволяют-ускорить-чтениезапись-за-счет-использования-буфера)
19) [Какой класс предназначен для работы с элементами файловой системы?](#Какой-класс-предназначен-для-работы-с-элементами-файловой-системы)
20) [Какие методы класса `File` вы знаете?](#Какие-методы-класса-file-вы-знаете)
21) [Что вы знаете об интерфейсе `FileFilter`?](#Что-вы-знаете-об-интерфейсе-filefilter)
22) [Как выбрать все элементы определенного каталога по критерию (например, с определенным расширением)?](#Как-выбрать-все-элементы-определенного-каталога-по-критерию-например-с-определенным-расширением)
23) [Что вы знаете о `RandomAccessFile`?](#Что-вы-знаете-о-randomaccessfile)
24) [Какие режимы доступа к файлу есть у `RandomAccessFile`?](#Какие-режимы-доступа-к-файлу-есть-у-randomaccessfile)
25) [Какие классы поддерживают чтение и запись потоков в компрессированном формате?](#Какие-классы-поддерживают-чтение-и-запись-потоков-в-компрессированном-формате)
26) [Существует ли возможность перенаправить потоки стандартного ввода/вывода?](#Существует-ли-возможность-перенаправить-потоки-стандартного-вводавывода)
27) [Какой символ является разделителем при указании пути в файловой системе?](#Какой-символ-является-разделителем-при-указании-пути-в-файловой-системе)
28) [Что такое _«абсолютный путь»_ и _«относительный путь»_?](#Что-такое-абсолютный-путь-и-относительный-путь)
29) [Что такое _«символьная ссылка»_?](#Что-такое-символьная-ссылка)
30) [Как работает метод read?](#Как-работает-метод-read)
31) [Разница между методами _`flush()`_ и _`close()`_ ?](#Разница-между-методами-flush-close)
32) [На каких паттернах основана иерархия потоков ввода/вывода?](#На-каких-паттернах-основана-иерархия-потоков-ввода-вывода)
33) [Когда использовать `Scanner` и `BufferedReader`. Различия и сходство?](#Когда-использовать-Scanner-и-BufferedReader-Различия-и-сходство)
+ [ССЫЛКИ НА ДОПОЛНИТЕЛЬНУЮ ИНФУ](#ССЫЛКИ-НА-ДОПОЛНИТЕЛЬНУЮ-ИНФУ)
...
+ [Thema#4 Question#1  Go to StreamAPIAndLambda](#Theme4___StreamAPIAndLambda)  
...
```
+ [Thema#4 Question#2  Go to StreamAPIAndLambda](#Theme4___StreamAPIAndLambda)  
...
```
+ [Thema#4 Question#3  Go to StreamAPIAndLambda](#Theme4___StreamAPIAndLambda)  
...
+ [Thema#4 Question#5  Go to StreamAPIAndLambda](#Theme4___StreamAPIAndLambda)  
...
+ [Thema#4 Question#6  Go to StreamAPIAndLambda](#Theme4___StreamAPIAndLambda)  
...
+ [Thema#4 Question#7  Go to StreamAPIAndLambda](#Theme4___StreamAPIAndLambda)  
...
+ [Thema#4 Question#8  Go to StreamAPIAndLambda](#Theme4___StreamAPIAndLambda)  
...
```
+ [Thema#4 Question#9  Go to StreamAPIAndLambda](#Theme4___StreamAPIAndLambda)  
...
+ [Thema#4 Question#10  Go to StreamAPIAndLambda](#Theme4___StreamAPIAndLambda)  
...
```
+ [Thema#4 Question#11  Go to StreamAPIAndLambda](#Theme4___StreamAPIAndLambda)  
...
+ [Thema#4 Question#12  Go to StreamAPIAndLambda](#Theme4___StreamAPIAndLambda)  
...
+ [Thema#4 Question#13  Go to StreamAPIAndLambda](#Theme4___StreamAPIAndLambda)  
...
+ [Thema#4 Question#14  Go to StreamAPIAndLambda](#Theme4___StreamAPIAndLambda)  
...
+ [Thema#4 Question#15  Go to StreamAPIAndLambda](#Theme4___StreamAPIAndLambda)  
...
+ [Thema#4 Question#16  Go to StreamAPIAndLambda](#Theme4___StreamAPIAndLambda)  
...
+ [Thema#4 Question#17  Go to StreamAPIAndLambda](#Theme4___StreamAPIAndLambda)  
...
+ [Thema#4 Question#18  Go to StreamAPIAndLambda](#Theme4___StreamAPIAndLambda)  
...
+ [Thema#4 Question#19  Go to StreamAPIAndLambda](#Theme4___StreamAPIAndLambda)  
...
+ [Thema#4 Question#20  Go to StreamAPIAndLambda](#Theme4___StreamAPIAndLambda)  
...
+ [Thema#4 Question#21  Go to StreamAPIAndLambda](#Theme4___StreamAPIAndLambda)  
...
+ [Thema#4 Question#22  Go to StreamAPIAndLambda](#Theme4___StreamAPIAndLambda)  
...
+ [Thema#4 Question#23  Go to StreamAPIAndLambda](#Theme4___StreamAPIAndLambda)  
...
```
+ [Thema#4 Question#24  Go to StreamAPIAndLambda](#Theme4___StreamAPIAndLambda)  
...
```
+ [Thema#4 Question#25  Go to StreamAPIAndLambda](#Theme4___StreamAPIAndLambda)  
...
```
+ [Thema#4 Question#26  Go to StreamAPIAndLambda](#Theme4___StreamAPIAndLambda)  
...
```
+ [Thema#4 Question#27  Go to StreamAPIAndLambda](#Theme4___StreamAPIAndLambda)  
...
Stream
    ...
    .forEach(System.out::println);
```
+ [Thema#4 Question#28  Go to StreamAPIAndLambda](#Theme4___StreamAPIAndLambda)  
...
System.out.println(
    Stream
        ...
        .count());
```
+ [Thema#4 Question#29  Go to StreamAPIAndLambda](#Theme4___StreamAPIAndLambda)  
...
(new Random())
    ...
    .forEach(System.out::println);
```
+ [Thema#4 Question#30  Go to StreamAPIAndLambda](#Theme4___StreamAPIAndLambda)  
...
Stream
    ...
    .getAsInt(); //55
```
+ [Thema#4 Question#31  Go to StreamAPIAndLambda](#Theme4___StreamAPIAndLambda)  
...
Stream
    ...
    .getAsInt(); //2
```
+ [Thema#4 Question#32  Go to StreamAPIAndLambda](#Theme4___StreamAPIAndLambda)  
...
Stream
    ...
    .sum(); //69
```
+ [Thema#4 Question#33  Go to StreamAPIAndLambda](#Theme4___StreamAPIAndLambda)  
...
Stream
    ...
    .getAsDouble(); //13.8
```
+ [Thema#4 Question#34  Go to StreamAPIAndLambda](#Theme4___StreamAPIAndLambda)  
...
```
+ [Thema#4 Question#35  Go to StreamAPIAndLambda](#Theme4___StreamAPIAndLambda)  
...
+ [Thema#4 Question#36  Go to StreamAPIAndLambda](#Theme4___StreamAPIAndLambda)  
...
```
+ [Thema#4 Question#37  Go to StreamAPIAndLambda](#Theme4___StreamAPIAndLambda)  
...
+ [Thema#4 Question#38  Go to StreamAPIAndLambda](#Theme4___StreamAPIAndLambda)  
...
+ [Thema#4 Question#39  Go to StreamAPIAndLambda](#Theme4___StreamAPIAndLambda)  
...
+ [Thema#4 Question#40  Go to StreamAPIAndLambda](#Theme4___StreamAPIAndLambda)  
...
+ [Thema#4 Question#41  Go to StreamAPIAndLambda](#Theme4___StreamAPIAndLambda)  
...
__Theme5 - InputOutputSreams________________________________________________________________________________________________
...
+ [Thema#5 Question#1  Go to InputOutputSreams](#Theme5___InputOutputSreams)  
...
+ [Thema#5 Question#2  Go to InputOutputSreams](#Theme5___InputOutputSreams)  
...
+ [Thema#5 Question#3  Go to InputOutputSreams](#Theme5___InputOutputSreams)  
...
+ [Thema#5 Question#4  Go to InputOutputSreams](#Theme5___InputOutputSreams)  
...
+ [Thema#5 Question#5  Go to InputOutputSreams](#Theme5___InputOutputSreams)  
...
+ [Thema#5 Question#6  Go to InputOutputSreams](#Theme5___InputOutputSreams)  
...
+ [Thema#5 Question#7  Go to InputOutputSreams](#Theme5___InputOutputSreams)  
...
+ [Thema#5 Question#8  Go to InputOutputSreams](#Theme5___InputOutputSreams)  
...
+ [Thema#5 Question#9  Go to InputOutputSreams](#Theme5___InputOutputSreams)  
...
+ [Thema#5 Question#10  Go to InputOutputSreams](#Theme5___InputOutputSreams)  
...
+ [Thema#5 Question#11  Go to InputOutputSreams](#Theme5___InputOutputSreams)  
...
+ [Thema#5 Question#12  Go to InputOutputSreams](#Theme5___InputOutputSreams)  
...
+ [Thema#5 Question#13  Go to InputOutputSreams](#Theme5___InputOutputSreams)  
...
+ [Thema#5 Question#14  Go to InputOutputSreams](#Theme5___InputOutputSreams)  
...
+ [Thema#5 Question#15  Go to InputOutputSreams](#Theme5___InputOutputSreams)  
...
+ [Thema#5 Question#16  Go to InputOutputSreams](#Theme5___InputOutputSreams)  
...
```
+ [Thema#5 Question#17  Go to InputOutputSreams](#Theme5___InputOutputSreams)  
...
+ [Thema#5 Question#18  Go to InputOutputSreams](#Theme5___InputOutputSreams)  
...
+ [Thema#5 Question#19  Go to InputOutputSreams](#Theme5___InputOutputSreams)  
...
+ [Thema#5 Question#20  Go to InputOutputSreams](#Theme5___InputOutputSreams)  
...
```
+ [Thema#5 Question#21  Go to InputOutputSreams](#Theme5___InputOutputSreams)  
...
```
+ [Thema#5 Question#22  Go to InputOutputSreams](#Theme5___InputOutputSreams)  
...
+ [Thema#5 Question#23  Go to InputOutputSreams](#Theme5___InputOutputSreams)  
...
+ [Thema#5 Question#24  Go to InputOutputSreams](#Theme5___InputOutputSreams)  
...
+ [Thema#5 Question#25  Go to InputOutputSreams](#Theme5___InputOutputSreams)  
...
+ [Thema#5 Question#26  Go to InputOutputSreams](#Theme5___InputOutputSreams)  
...
+ [Thema#5 Question#27  Go to InputOutputSreams](#Theme5___InputOutputSreams)  
...
+ [Thema#5 Question#28  Go to InputOutputSreams](#Theme5___InputOutputSreams)  
...
+ [Thema#5 Question#29  Go to InputOutputSreams](#Theme5___InputOutputSreams)  
...
+ [Thema#5 Question#30  Go to InputOutputSreams](#Theme5___InputOutputSreams)  
...
+ [Thema#5 Question#31  Go to InputOutputSreams](#Theme5___InputOutputSreams)  
...
+ [Thema#5 Question#32  Go to InputOutputSreams](#Theme5___InputOutputSreams)  
...
+ [Thema#5 Question#33  Go to InputOutputSreams](#Theme5___InputOutputSreams)  
...
+ [Класс Scanner-->](https://javarush.ru/groups/posts/klass-scanner)
+ [Система ввода/вывода-->](http://developer.alexanderklimov.ru/android/java/io.php)
...
+ [BufferedReader и BufferedWriter-->](https://javarush.ru/groups/posts/593-bufferedreader-i-bufferedwritter)
+ [Java NIO — Краткое руководство-->](https://coderlessons.com/tutorials/java-tekhnologii/vyuchit-java-nio/java-nio-kratkoe-rukovodstvo)
+ [NIO (Java, обучающая статья)-->](http://www.quizful.net/post/java-nio-tutorial)
+ [Работа со сканером в Java (ввод и вывод данных)-->](https://vertex-academy.com/tutorials/ru/rabota-so-skannerom-v-java/)
+ [Java Charset примеры использования-->](https://java.hotexamples.com/ru/examples/java.io/Charset/-/java-charset-class-examples.html)
+ [Потоки ввода-вывода-->](http://java-course.ru/begin/io_file/)
+ [Использование класса Scanner в Java — примеры и методы-->](https://hr-vector.com/java/class-scanner)
