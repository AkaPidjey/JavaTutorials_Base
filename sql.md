...
+ [Нюансы работы с NULL в SQL. Как проверить поле на NULL?](#Нюансы-работы-с-NULL-в-SQL-Как-проверить-поле-на-NULL)
+ [Виды Join’ов?](#Виды-Join’ов)
...
+ [Механизмы оптимизации запросов в БД](#Механизмы-оптимизации-запросов-в-БД)
